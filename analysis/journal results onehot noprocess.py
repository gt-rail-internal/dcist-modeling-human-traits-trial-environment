...
for team in team_indexes:
    ...
    rand_a_3 = random.sample(range(len(tasks)), len(team))
    ...
    for i in range(len(team)):
        ...
        rand_value_3 += user_scores[idx][tasks[rand_a_3[i]]]

    score_data.append([best_value, pred_value, worst_value, rand_value, rand_value_2, rand_value_3])  # record the score data
